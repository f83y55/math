...
for (var key in hashtable){
	...
	for (var item of hashtable[key]){
		console.log("path : " + item["path"] + "| default : " + item["default"]);
			console.log(((item["path"].endsWith(".css"))&&(item["default"]||(import_module.includes(key)))));
...
<div class=\"navbar-collapse\">                 <div class=\"navbar-group\">                     <div class=\"navbar-item\">
				<h2 class=\"nocounter navbar-text\">
				Mathématiques
				</h2>
